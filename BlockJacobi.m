...
function [Q, D, flops, sweeps, sweep_OffNorm_history] = BlockJacobi(A, blockSizes, eps_threshold, ordering, pivot_method, n3_ratio)
    % Block Jacobi Algorithm for Symmetric Eigenproblem
    % Inputs:
