function [Q, D, flops, sweeps, sweep_OffNorm_history, new_break_flag] = ...
    ...
    % vanilla Recursive Jacobi Algorithm with a pre-determined maximum recursion depth for the Symmetric Eigenproblem
    % Inputs:
    %   A - symmetric matrix
    ...
    %   max_recdepth - pre-determined maximum recursion depth
    ...
    % Base case: if recursion depth reaches the pre-determined maximum recursion depth, solve eigenproblem directly
