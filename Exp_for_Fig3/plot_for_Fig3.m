...
% Example usage
n_size = 64;
num_blocks = 32;  % Different num_blocks values for Block Jacobi
...
%% Below are updated experiments for anti-diagonal ordering with QRCP and LUPP
% 6. Adversarial anti-diagonal QRCP
A1 = A;
fprintf("Adversarial anti-diagonal QRCP\n");
tic;
[Q_adv_AD_qrcp, D_adv_AD_qrcp, flops_adv_AD_qrcp, sweeps_adv_AD_qrcp, sweep_OffNorm_history_adv_AD_qrcp] = BlockJacobi_adv(A1, blockSizes, eps_threshold, "anti-diagonal", "qrcp", n3_ratio);
time_adv_AD_qrcp = toc;
results_blockjacobi(6).label = 'Adv-AntiDiagonal-QRCP';
results_blockjacobi(6).Q = Q_adv_AD_qrcp;
results_blockjacobi(6).D = D_adv_AD_qrcp;
results_blockjacobi(6).flops = flops_adv_AD_qrcp;
results_blockjacobi(6).sweeps = sweeps_adv_AD_qrcp;
results_blockjacobi(6).history = sweep_OffNorm_history_adv_AD_qrcp;
results_blockjacobi(6).time = time_adv_AD_qrcp;

% 7. Adversarial anti-diagonal LUPP
A1 = A;
fprintf("Adversarial anti-diagonal LUPP\n");
tic;
[Q_adv_AD_lupp, D_adv_AD_lupp, flops_adv_AD_lupp, sweeps_adv_AD_lupp, sweep_OffNorm_history_adv_AD_lupp] = BlockJacobi_adv(A1, blockSizes, eps_threshold, "anti-diagonal", "lupp", n3_ratio);
time_adv_AD_lupp = toc;
results_blockjacobi(7).label = 'Adv-AntiDiagonal-LUPP';
results_blockjacobi(7).Q = Q_adv_AD_lupp;
results_blockjacobi(7).D = D_adv_AD_lupp;
results_blockjacobi(7).flops = flops_adv_AD_lupp;
results_blockjacobi(7).sweeps = sweeps_adv_AD_lupp;
results_blockjacobi(7).history = sweep_OffNorm_history_adv_AD_lupp;
results_blockjacobi(7).time = time_adv_AD_lupp;
%% Plotting
...
colors = lines(length(results_blockjacobi));
markers = {'*', 's', 'd', '^', 'v', 'square', 'diamond'};
...
% % Store the data
% save('Fig3_machine_512.mat');
% savefig('Fig3_machine_512.fig');
% close(gcf);