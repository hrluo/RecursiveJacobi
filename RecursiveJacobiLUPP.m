function [Q, D, flops, sweeps, sweep_OffNorm_history, new_break_flag] = ...
    RecursiveJacobiLUPP(A, n_threshold, f, eps_threshold, recdepth, break_flag, ...
                              n3_ratio)
    % Recursive Jacobi Algorithm with LUPP for the Symmetric Eigenproblem
    % Inputs:
    %   A - symmetric matrix
